...
const GigsListNextFive = ({ gigs }) => {
	...
	// }, [weights]);
	return (
		<StyledGigsListNextFive className='gig-list-container'>
			{/* <p className='gigs-list-header'>Recorded weigh-ins</p> */}
			<div className='gigs-list'>
				{gigs && gigs.map((gig) => <GigCard key={gig.createdAt} gig={gig} />)}
			</div>
		</StyledGigsListNextFive>
	);
};
...
export default GigsListNextFive;
