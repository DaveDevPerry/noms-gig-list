...
const BandFilteredGigsList = ({ gigs }) => {
	...
	// }, [weights]);
	return (
		<StyledBandFilteredGigsList className='gig-list-container'>
		...
		</StyledBandFilteredGigsList>
	);
};
const StyledBandFilteredGigsList = styled.div`
	/* overflow-y: scroll; */
	overflow-y: auto;
	flex: 1;
	/* border: 2px solid; */
...
export default BandFilteredGigsList;
